...
@allure.title("Переход на страницу оформления заказа через навигационное меню")
def test_open_checkout_via_nav_menu(browser):
    logging.info("Start test_open_checkout_via_nav_menu")
    ...
    logging.info("Finish test_open_checkout_via_nav_menu")
