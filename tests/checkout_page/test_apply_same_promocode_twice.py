...
def test_apply_same_promocode_twice(browser):
    logging.info("Start test_apply_same_promocode_twice")
    ...
    assert_text_in_element(browser, (By.XPATH, "//ul[contains(@class, 'woocommerce-error')]//li"),
                           "Coupon code already applied!", "Проверить, что отображается текст в сообщении")

    logging.info("Finish test_apply_same_promocode_twice")
