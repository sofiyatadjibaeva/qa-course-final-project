...
@allure.title("Добавление пиццы в корзину через слайдер")
def test_add_pizza_to_cart_from_slider(browser):
    logging.info("Start test_add_pizza_to_cart_from_slider")
    ...
    logging.info("Finish test_add_pizza_to_cart_from_slider")
